...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PopulatedPlaceSummary', function() {
      beforeEach(function() {
        instance = new GeoDb.PopulatedPlaceSummary();
      });

      it('should create an instance of PopulatedPlaceSummary', function() {
        // TODO: update the code to test PopulatedPlaceSummary
        expect(instance).to.be.a(GeoDb.PopulatedPlaceSummary);
      });
      ...
      it('should have the property population (base name: "population")', function() {
        // TODO: update the code to test the property population
        expect(instance).to.have.property('population');
        // expect(instance.population).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property regionWdId (base name: "regionWdId")', function() {
        // TODO: update the code to test the property regionWdId
        expect(instance).to.have.property('regionWdId');
        // expect(instance.regionWdId).to.be(expectedValueLiteral);
      });
