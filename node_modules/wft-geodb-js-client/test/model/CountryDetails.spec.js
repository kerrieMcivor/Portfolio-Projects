  ...
  describe('(package)', function() {
    describe('CountryDetails', function() {
      ...
      it('should have the property callingCode (base name: "callingCode")', function() {
        // TODO: update the code to test the property callingCode
        expect(instance).to.have.property('callingCode');
        // expect(instance.callingCode).to.be(expectedValueLiteral);
      });

      it('should have the property currencyCodes (base name: "currencyCodes")', function() {
        // TODO: update the code to test the property currencyCodes
        expect(instance).to.have.property('currencyCodes');
        // expect(instance.currencyCodes).to.be(expectedValueLiteral);
      });

      it('should have the property flagImageUri (base name: "flagImageUri")', function() {
        // TODO: update the code to test the property flagImageUri
        expect(instance).to.have.property('flagImageUri');
        // expect(instance.flagImageUri).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property numRegions (base name: "numRegions")', function() {
        // TODO: update the code to test the property numRegions
        expect(instance).to.have.property('numRegions');
        // expect(instance.numRegions).to.be(expectedValueLiteral);
      });

      it('should have the property wikiDataId (base name: "wikiDataId")', function() {
        // TODO: update the code to test the property wikiDataId
        expect(instance).to.have.property('wikiDataId');
        // expect(instance.wikiDataId).to.be(expectedValueLiteral);
      });
