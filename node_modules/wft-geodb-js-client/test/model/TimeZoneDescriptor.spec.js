...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TimeZoneDescriptor', function() {
      beforeEach(function() {
        instance = new GeoDb.TimeZoneDescriptor();
      });

      it('should create an instance of TimeZoneDescriptor', function() {
        // TODO: update the code to test TimeZoneDescriptor
        expect(instance).to.be.a(GeoDb.TimeZoneDescriptor);
      });
      ...
      it('should have the property rawUtcOffsetHours (base name: "rawUtcOffsetHours")', function() {
        // TODO: update the code to test the property rawUtcOffsetHours
        expect(instance).to.have.property('rawUtcOffsetHours');
        // expect(instance.rawUtcOffsetHours).to.be(expectedValueLiteral);
      });
