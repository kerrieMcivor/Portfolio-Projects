...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Metadata', function() {
      beforeEach(function() {
        instance = new GeoDb.Metadata();
      });

      it('should create an instance of Metadata', function() {
        // TODO: update the code to test Metadata
        expect(instance).to.be.a(GeoDb.Metadata);
      });

      it('should have the property currentOffset (base name: "currentOffset")', function() {
        // TODO: update the code to test the property currentOffset
        expect(instance).to.have.property('currentOffset');
        // expect(instance.currentOffset).to.be(expectedValueLiteral);
      });
