...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ErrorCode', function() {
      ...
      it('should have the property ACCESS_DENIED', function() {
        expect(instance).to.have.property('ACCESS_DENIED');
        expect(instance.ACCESS_DENIED).to.be("ACCESS_DENIED");
      });

      it('should have the property ENTITY_NOT_FOUND', function() {
        expect(instance).to.have.property('ENTITY_NOT_FOUND');
        expect(instance.ENTITY_NOT_FOUND).to.be("ENTITY_NOT_FOUND");
      });

      it('should have the property INCOMPATIBLE', function() {
        expect(instance).to.have.property('INCOMPATIBLE');
        expect(instance.INCOMPATIBLE).to.be("INCOMPATIBLE");
      });

      it('should have the property PARAM_INVALID', function() {
        expect(instance).to.have.property('PARAM_INVALID');
        expect(instance.PARAM_INVALID).to.be("PARAM_INVALID");
      });

      it('should have the property PARAMS_MUTUALLY_EXCLUSIVE', function() {
        expect(instance).to.have.property('PARAMS_MUTUALLY_EXCLUSIVE');
        expect(instance.PARAMS_MUTUALLY_EXCLUSIVE).to.be("PARAMS_MUTUALLY_EXCLUSIVE");
      });

      it('should have the property REQUEST_UNPROCESSABLE', function() {
        expect(instance).to.have.property('REQUEST_UNPROCESSABLE');
        expect(instance.REQUEST_UNPROCESSABLE).to.be("REQUEST_UNPROCESSABLE");
      });
