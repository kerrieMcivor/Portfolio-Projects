...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RegionDetails', function() {
      beforeEach(function() {
        instance = new GeoDb.RegionDetails();
      });

      it('should create an instance of RegionDetails', function() {
        // TODO: update the code to test RegionDetails
        expect(instance).to.be.a(GeoDb.RegionDetails);
      });
      ...
      it('should have the property fipsCode (base name: "fipsCode")', function() {
        // TODO: update the code to test the property fipsCode
        expect(instance).to.have.property('fipsCode');
        // expect(instance.fipsCode).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property numCities (base name: "numCities")', function() {
        // TODO: update the code to test the property numCities
        expect(instance).to.have.property('numCities');
        // expect(instance.numCities).to.be(expectedValueLiteral);
      });
