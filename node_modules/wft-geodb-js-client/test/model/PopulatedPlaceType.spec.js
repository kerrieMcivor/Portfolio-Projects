...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PopulatedPlaceType', function() {
      beforeEach(function() {
        instance = GeoDb.PopulatedPlaceType;
      });

      it('should create an instance of PopulatedPlaceType', function() {
        // TODO: update the code to test PopulatedPlaceType
        expect(instance).to.be.a('object');
      });

      it('should have the property aDM2', function() {
        expect(instance).to.have.property('aDM2');
        expect(instance.aDM2).to.be("ADM2");
      });

      it('should have the property CITY', function() {
        expect(instance).to.have.property('CITY');
        expect(instance.CITY).to.be("CITY");
      });

      it('should have the property ISLAND', function() {
        expect(instance).to.have.property('ISLAND');
        expect(instance.ISLAND).to.be("ISLAND");
      });
