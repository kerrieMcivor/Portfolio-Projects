...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseResponse', 'model/CountryDetails', 'model/Error'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseResponse'), require('./CountryDetails'), require('./Error'));
  } else {
    // Browser globals (root is window)
    if (!root.GeoDb) {
      root.GeoDb = {};
    }
    root.GeoDb.CountryResponse = factory(root.GeoDb.ApiClient, root.GeoDb.BaseResponse, root.GeoDb.CountryDetails, root.GeoDb.Error);
  }
}(this, function(ApiClient, BaseResponse, CountryDetails, Error) {
  'use strict';
