...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseCollectionResponse', 'model/Error', 'model/LanguageDescriptor', 'model/Link', 'model/Metadata'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseCollectionResponse'), require('./Error'), require('./LanguageDescriptor'), require('./Link'), require('./Metadata'));
  } else {
    // Browser globals (root is window)
    if (!root.GeoDb) {
      root.GeoDb = {};
    }
    root.GeoDb.LanguagesResponse = factory(root.GeoDb.ApiClient, root.GeoDb.BaseCollectionResponse, root.GeoDb.Error, root.GeoDb.LanguageDescriptor, root.GeoDb.Link, root.GeoDb.Metadata);
  }
}(this, function(ApiClient, BaseCollectionResponse, Error, LanguageDescriptor, Link, Metadata) {
  'use strict';
