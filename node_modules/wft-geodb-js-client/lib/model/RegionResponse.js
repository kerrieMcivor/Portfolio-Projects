...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseResponse', 'model/Error', 'model/RegionDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseResponse'), require('./Error'), require('./RegionDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.GeoDb) {
      root.GeoDb = {};
    }
    root.GeoDb.RegionResponse = factory(root.GeoDb.ApiClient, root.GeoDb.BaseResponse, root.GeoDb.Error, root.GeoDb.RegionDetails);
  }
}(this, function(ApiClient, BaseResponse, Error, RegionDetails) {
  'use strict';
