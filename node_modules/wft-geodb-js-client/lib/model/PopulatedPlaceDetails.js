...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PopulatedPlaceType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PopulatedPlaceType'));
  } else {
    // Browser globals (root is window)
    if (!root.GeoDb) {
      root.GeoDb = {};
    }
    root.GeoDb.PopulatedPlaceDetails = factory(root.GeoDb.ApiClient, root.GeoDb.PopulatedPlaceType);
  }
}(this, function(ApiClient, PopulatedPlaceType) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('regionWdId'))
        obj.regionWdId = ApiClient.convertToType(data['regionWdId'], 'String');
   ...
   */
  exports.prototype.elevationMeters = undefined;
   ...
   * @member {String} regionWdId
   */
  exports.prototype.regionWdId = undefined;
   ...
   */
  exports.prototype.wikiDataId = undefined;
