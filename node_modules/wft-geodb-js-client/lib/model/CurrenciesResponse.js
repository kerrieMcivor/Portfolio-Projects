...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseCollectionResponse', 'model/Currency', 'model/Error', 'model/Link', 'model/Metadata'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseCollectionResponse'), require('./Currency'), require('./Error'), require('./Link'), require('./Metadata'));
  } else {
    // Browser globals (root is window)
    if (!root.GeoDb) {
      root.GeoDb = {};
    }
    root.GeoDb.CurrenciesResponse = factory(root.GeoDb.ApiClient, root.GeoDb.BaseCollectionResponse, root.GeoDb.Currency, root.GeoDb.Error, root.GeoDb.Link, root.GeoDb.Metadata);
  }
}(this, function(ApiClient, BaseCollectionResponse, Currency, Error, Link, Metadata) {
  'use strict';
