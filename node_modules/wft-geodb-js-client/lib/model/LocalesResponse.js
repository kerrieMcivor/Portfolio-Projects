...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseCollectionResponse', 'model/Error', 'model/Link', 'model/Locale', 'model/Metadata'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseCollectionResponse'), require('./Error'), require('./Link'), require('./Locale'), require('./Metadata'));
  } else {
    // Browser globals (root is window)
    if (!root.GeoDb) {
      root.GeoDb = {};
    }
    root.GeoDb.LocalesResponse = factory(root.GeoDb.ApiClient, root.GeoDb.BaseCollectionResponse, root.GeoDb.Error, root.GeoDb.Link, root.GeoDb.Locale, root.GeoDb.Metadata);
  }
}(this, function(ApiClient, BaseCollectionResponse, Error, Link, Locale, Metadata) {
  'use strict';
