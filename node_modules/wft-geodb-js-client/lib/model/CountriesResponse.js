...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseCollectionResponse', 'model/CountrySummary', 'model/Error', 'model/Link', 'model/Metadata'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseCollectionResponse'), require('./CountrySummary'), require('./Error'), require('./Link'), require('./Metadata'));
  } else {
    // Browser globals (root is window)
    if (!root.GeoDb) {
      root.GeoDb = {};
    }
    root.GeoDb.CountriesResponse = factory(root.GeoDb.ApiClient, root.GeoDb.BaseCollectionResponse, root.GeoDb.CountrySummary, root.GeoDb.Error, root.GeoDb.Link, root.GeoDb.Metadata);
  }
}(this, function(ApiClient, BaseCollectionResponse, CountrySummary, Error, Link, Metadata) {
  'use strict';
