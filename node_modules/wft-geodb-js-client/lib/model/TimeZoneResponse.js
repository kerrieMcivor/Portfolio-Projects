...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseResponse', 'model/Error'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseResponse'), require('./Error'));
  } else {
    // Browser globals (root is window)
    if (!root.GeoDb) {
      root.GeoDb = {};
    }
    root.GeoDb.TimeZoneResponse = factory(root.GeoDb.ApiClient, root.GeoDb.BaseResponse, root.GeoDb.Error);
  }
}(this, function(ApiClient, BaseResponse, Error) {
  'use strict';
   ...
   */
  exports.prototype.rawUtcOffsetHours = undefined;
