...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseResponse', 'model/Error', 'model/Link', 'model/Metadata'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseResponse'), require('./Error'), require('./Link'), require('./Metadata'));
  } else {
    // Browser globals (root is window)
    if (!root.GeoDb) {
      root.GeoDb = {};
    }
    root.GeoDb.BaseCollectionResponse = factory(root.GeoDb.ApiClient, root.GeoDb.BaseResponse, root.GeoDb.Error, root.GeoDb.Link, root.GeoDb.Metadata);
  }
}(this, function(ApiClient, BaseResponse, Error, Link, Metadata) {
  'use strict';
