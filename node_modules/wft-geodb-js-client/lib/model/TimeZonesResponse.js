...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseCollectionResponse', 'model/Error', 'model/Link', 'model/Metadata', 'model/TimeZoneDescriptor'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseCollectionResponse'), require('./Error'), require('./Link'), require('./Metadata'), require('./TimeZoneDescriptor'));
  } else {
    // Browser globals (root is window)
    if (!root.GeoDb) {
      root.GeoDb = {};
    }
    root.GeoDb.TimeZonesResponse = factory(root.GeoDb.ApiClient, root.GeoDb.BaseCollectionResponse, root.GeoDb.Error, root.GeoDb.Link, root.GeoDb.Metadata, root.GeoDb.TimeZoneDescriptor);
  }
}(this, function(ApiClient, BaseCollectionResponse, Error, Link, Metadata, TimeZoneDescriptor) {
  'use strict';
